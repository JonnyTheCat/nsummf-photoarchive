...
class Photo(models.Model):
    description = models.CharField("Описание", max_length=255, default="Нет описания")  # Описание
    author = models.CharField("Автор", max_length=30, default='Неизвестно')  # Автор фотографии
